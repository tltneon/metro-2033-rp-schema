...
function entityMeta:GetItemTable(entity)
	return self:getItemTable(entity)
end
function entityMeta:GetData(key, default)
...
function playerMeta:Ban(tm, _)
	self:getChar():ban(tm)
end
function playerMeta:Kick(_)
	self:kick()
end
